...
describe('ChoiceComponent', () => {
    ...
    beforeEach(() => {
        ...
        component = new ChoiceComponent(formBuilder);
    });
    ...
    it('should create a form group with default values', () => {
        const answerField = component.createAnswerField();
        expect(answerField.value.text).toBe('');
        expect(answerField.value.isCorrect).toBe(false);
    });
